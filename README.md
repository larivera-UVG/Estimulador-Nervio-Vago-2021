...
## Modulo Estimulador
Este es el primero de los dos modulos que conforman el sistema de estimualcion VNS. Este modulo es el encargado de generar la estimulacion electrica responsable de administrar el tratamiento. Es un modulo de 3cm de diametro, conformado completamente por componentes SMD a medida de reducir su tamano.
### Funcionamiento
El modulo estimulador es un circuito digital que consiste de 3 partes clave. Primero se tiene como microcontrolador un ATSAMD21E18-MU para ser usado y programado como un _Trinket M0_. Luego tenemos tenemos un regulador de voltaje que convierte la entrada de 5 V a una salida de 3.3 V. Luego se tiene un convertidor de voltaje a corriente XTR 111 que se encarga de tomar la senal PWM que producida por el ATSAMD21E18, y transforma los pulsos de voltaje a su equivalente en corriente por medio de un espejo de corriente que utiliza de manera externa un circuito con un MOSFET para regular la salida. Para poder alimentar la fuente de corriete que se genera apartir del convertidor de voltaje a corriente se tiene un circuito elevador de voltaje por medio de un LM2622 que opera a 600 kHz. Este provee la alimentacion de 7 volts que es necesaria para activar el convertidor de voltaje a corriente. or ultimo se tiene un Mini-NRF24L01 que se encarga de recibir los parametros de estimulacion enviador por medio de la varilla programadora.
### Codigos
